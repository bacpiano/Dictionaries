...
//["crows"] is the key of the item to add to dictionary
//["murder"] is the value associate with the key
...
//dynamicType - like variables those types can be changed after their declaration
//commonly associated with operations for dictionaries (remove, add, update, etc.)
group.dynamicType
